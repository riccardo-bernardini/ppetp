...
package body PPETP.Attributes.New_Peer is
      ...
      if Version = 4 then
         ...
         begin
            ...
            begin
               ...
               return Access_Attribute_Class'( new NEW_PEER_Attribute'(Attr_Type  => NEW_PEER_Attribute_Index,
                                                                       T_Protocol => Protocol,
                                                                       Address    => Addr,
                                                                       PeerID     => Id));
            end;
   ...
   -- Building_Data --
   -------------------
   function Building_Data(Object: NEW_PEER_Attribute) return byte_array is
      type Peer_Id_Buffer is new Byte_Array(1..4);
   ...
   begin
      Object.Attr_Type  := NEW_PEER_Attribute_Index;
   ...
   -- Get_Address --
   -----------------
   function Get_Address(Object : NEW_PEER_Attribute) return Sock_Addr_Type is
   begin
   ...
   -- Get_PeerID --
   ----------------
   function Get_PeerID(Object : NEW_PEER_Attribute) return Peer_ID is
   begin
   ...
   -- Image --
   -----------
   procedure Image(Object : NEW_PEER_Attribute) is
   begin
...
begin
   ...
   PPETP.Attributes.Register(Index    => NEW_PEER_Attribute_Index,
