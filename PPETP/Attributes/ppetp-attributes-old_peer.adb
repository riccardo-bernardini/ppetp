...
package body PPETP.Attributes.Old_Peer is
      ...
      if Version = 4 then
         ...
         begin
            ...
            begin
               ...
               return Access_Attribute_Class'( new OLD_PEER_Attribute'(Attr_Type  => OLD_PEER_Attribute_Index,
                                                                       T_Protocol => Protocol,
                                                                       Address    => Addr,
                                                                       PeerID     => Id));
            end;
   ...
   -- Building_Data --
   -------------------
   function Building_Data(Object: OLD_PEER_Attribute) return byte_array is
      type Peer_Id_Buffer is new Byte_Array(1..4);
   ...
   -- Get_Address --
   -----------------
   function Get_Address(Object : OLD_PEER_Attribute) return Sock_Addr_Type is
   begin
   ...
   -- Get_PeerID --
   ----------------
   function Get_PeerID(Object : OLD_PEER_Attribute) return Peer_ID is
   begin
...
begin
   ...
   PPETP.Attributes.Register(Index    => OLD_PEER_Attribute_Index,
